...
| E1 | test | In-flight sampling correctness: multi-tick delta accumulation without double count, finish-path final delta flush + execCtx cleanup, reset/nil RUDetails safety; plus SQL/Plan meta registration when TopSQL is off and TopRU is on, and executor compile check after begin-hook context wiring. | 79c127237912c0719f7b9334970514c263568ded | 2026-02-02T10:30:08Z | local-macos (Go test) | `go test -tags=intest ./pkg/util/topsql/stmtstats -run 'TestOnExecutionBeginFinishRU|TestMergeRUIntoInFlightSamplingAndFinishDedup|TestMergeRUIntoHandlesRUResetAndNilRUDetails' -count=1`; `go test -tags=intest ./pkg/executor -run TestObserveStmtBeginForTopSQL_RegisterSQLPlanMeta_WhenTopRUEnabledAndTopSQLDisabled -count=1`; `go test -tags=intest ./pkg/executor -run TestDoesNotExist -count=1` | ./artifacts/evidence/E1/stmtstats_inflight_sampling_test.log; ./artifacts/evidence/E1/f3_topru_meta_registration.log; ./artifacts/evidence/E1/executor_compile_check.log |
